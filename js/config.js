...
var closedData = "<b>Site Name:</b> ${Site_Name}</br>" + "<b>Event ID:</b> ${Event_ID}</br>" + "<b>Facility ID:</b> ${Facility_ID}</br>" +
...
var tier4Data = closedData + "<a href=" + pdfURL + " target='_blank'>Download PDF</a> </br>";
/*--Identify Ops--*/
var identifyOps;
